...
pub const CLI_EXACT_REGRESSION: &[([&str; 2], &str)] = &[
    ...
    (
        ["claim-propagation-check", "1"],
        "CLAIM_PROPAGATION_OK seed=1 original=12 derived=6 restored_sources=6 direct_sources=0 distance1=6 derived_supporting=6 bytes=70983",
    ),
    (
        ["claim-propagation-check", "2"],
        "CLAIM_PROPAGATION_OK seed=2 original=12 derived=6 restored_sources=6 direct_sources=0 distance1=6 derived_supporting=6 bytes=70982",
    ),
    (
        ["succession-check", "1"],
        "SUCCESSION_OK seed=1 realms=6 candidates=18 direct_winners=6 restored_winners=0 derived_winners=0 vacancies=6 realm01_bytes=71915",
    ),
    (
        ["succession-check", "2"],
        "SUCCESSION_OK seed=2 realms=6 candidates=18 direct_winners=6 restored_winners=0 derived_winners=0 vacancies=6 realm01_bytes=71914",
    ),
    (
        ["replay-check", "1"],
